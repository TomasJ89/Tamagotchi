const animalsPlace = document.querySelector(".animalsPlace") as HTMLElement;
const gameMain = document.querySelector(".game") as HTMLElement
const playButton = document.getElementById("play") as HTMLElement;
const chooseAnimal = document.querySelector(".chooseAnimal") as HTMLElement
const walkingPlace = document.querySelector(".walkingPlace") as HTMLElement
const healthBar = document.querySelector(".healthBar") as HTMLElement
const hungryBar = document.querySelector(".hungryBar") as HTMLElement
const funBar = document.querySelector(".funBar") as HTMLElement
const playWithPetButton = document.getElementById("playWithPet") as HTMLElement
const feedButton = document.getElementById("feed") as HTMLElement
const gameContainer = document.querySelector(".gameContainer") as HTMLElement
const pointsHTML = document.querySelector("h3") as HTMLElement
const playingContainer = document.querySelector(".playingContainer") as HTMLElement
const foodItems = document.querySelector(".foodItems") as HTMLElement
const levelHtml = document.querySelector("h4") as HTMLElement
